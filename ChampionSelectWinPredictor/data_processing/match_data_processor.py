...
class MatchDataProcessor:
    ...
    def compute_team_heuristics(self, team_champion_ids):
        ...
        counts = {
            ...
            'hasGoodWaveClear': 0,
            'hasPoorWaveClear': 0,
            'isGoodAtTakingBaron': 0,
            'isGoodAtTakingDragon': 0,
            'isGoodAtTakingTurrets': 0,
            'hasGlobalUltimate': 0,
            'hasSemiGlobalUltimate': 0,
            'isSkillshotBased': 0,
            'isPointAndClick': 0,
            'isItemDependent': 0,
            'isLessItemDependent': 0,
            'hasHighAttackRange': 0,
            'hasLowAttackRange': 0,
            'isResistantToBurst': 0,
            'isVulnerableToBurst': 0,
            'isGoodRoamer': 0,
            'isLaneLocked': 0,
            'benefitsFromAlliedCC': 0,
            'isAOE': 0,
            'isSingleTarget': 0
